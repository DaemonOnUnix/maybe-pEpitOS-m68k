...
enum opt_code
{
  ...
  OPT_list = 1595,                           /* -list */
  /* OPT_m5200 = 1596, */                    /* -m5200 */
  /* OPT_m5206e = 1597, */                   /* -m5206e */
  /* OPT_m528x = 1598, */                    /* -m528x */
  /* OPT_m5307 = 1599, */                    /* -m5307 */
  /* OPT_m5407 = 1600, */                    /* -m5407 */
  /* OPT_m68000 = 1601, */                   /* -m68000 */
  /* OPT_m68010 = 1602, */                   /* -m68010 */
  /* OPT_m68020 = 1603, */                   /* -m68020 */
  OPT_m68020_40 = 1604,                      /* -m68020-40 */
  OPT_m68020_60 = 1605,                      /* -m68020-60 */
  /* OPT_m68030 = 1606, */                   /* -m68030 */
  /* OPT_m68040 = 1607, */                   /* -m68040 */
  /* OPT_m68060 = 1608, */                   /* -m68060 */
  /* OPT_m68302 = 1609, */                   /* -m68302 */
  /* OPT_m68332 = 1610, */                   /* -m68332 */
  OPT_m68851 = 1611,                         /* -m68851 */
  OPT_m68881 = 1612,                         /* -m68881 */
  OPT_malign_int = 1613,                     /* -malign-int */
  OPT_march_ = 1614,                         /* -march= */
  OPT_mbitfield = 1615,                      /* -mbitfield */
  /* OPT_mc68000 = 1616, */                  /* -mc68000 */
  /* OPT_mc68020 = 1617, */                  /* -mc68020 */
  /* OPT_mcfv4e = 1618, */                   /* -mcfv4e */
  /* OPT_mcpu32 = 1619, */                   /* -mcpu32 */
  OPT_mcpu_ = 1620,                          /* -mcpu= */
  OPT_mdiv = 1621,                           /* -mdiv */
  OPT_mfidoa = 1622,                         /* -mfidoa */
  OPT_mhard_float = 1623,                    /* -mhard-float */
  OPT_mid_shared_library = 1624,             /* -mid-shared-library */
  OPT_mlong_jump_table_offsets = 1625,       /* -mlong-jump-table-offsets */
  OPT_mnobitfield = 1626,                    /* -mnobitfield */
  OPT_mnortd = 1627,                         /* -mnortd */
  OPT_mnoshort = 1628,                       /* -mnoshort */
  OPT_mpcrel = 1629,                         /* -mpcrel */
  OPT_mrtd = 1630,                           /* -mrtd */
  OPT_msep_data = 1631,                      /* -msep-data */
  OPT_mshared_library_id_ = 1632,            /* -mshared-library-id= */
  OPT_mshort = 1633,                         /* -mshort */
  OPT_msoft_float = 1634,                    /* -msoft-float */
  OPT_mstrict_align = 1635,                  /* -mstrict-align */
  OPT_mtune_ = 1636,                         /* -mtune= */
  OPT_mxgot = 1637,                          /* -mxgot */
  OPT_mxtls = 1638,                          /* -mxtls */
  OPT_n = 1639,                              /* -n */
  OPT_name_sort = 1640,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1641,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1642,              /* -no-integrated-cpp */
  OPT_no_pie = 1643,                         /* -no-pie */
  OPT_nocpp = 1644,                          /* -nocpp */
  OPT_nodefaultlibs = 1645,                  /* -nodefaultlibs */
  OPT_nolibc = 1646,                         /* -nolibc */
  OPT_nophoboslib = 1647,                    /* -nophoboslib */
  OPT_nostartfiles = 1648,                   /* -nostartfiles */
  OPT_nostdinc = 1649,                       /* -nostdinc */
  OPT_nostdinc__ = 1650,                     /* -nostdinc++ */
  OPT_nostdlib = 1651,                       /* -nostdlib */
  OPT_o = 1652,                              /* -o */
  OPT_objects = 1653,                        /* -objects */
  OPT_p = 1654,                              /* -p */
  OPT_pass_exit_codes = 1655,                /* -pass-exit-codes */
  /* OPT_pedantic = 1656, */                 /* -pedantic */
  OPT_pedantic_errors = 1657,                /* -pedantic-errors */
  OPT_pg = 1658,                             /* -pg */
  OPT_pie = 1659,                            /* -pie */
  OPT_pipe = 1660,                           /* -pipe */
  OPT_print_file_name_ = 1661,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1662,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1663,          /* -print-multi-directory */
  OPT_print_multi_lib = 1664,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1665,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1666,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1667,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1668,               /* -print-prog-name= */
  OPT_print_search_dirs = 1669,              /* -print-search-dirs */
  OPT_print_sysroot = 1670,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1671,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1672,                    /* -print-value */
  OPT_quiet = 1673,                          /* -quiet */
  OPT_r = 1674,                              /* -r */
  OPT_remap = 1675,                          /* -remap */
  OPT_reverse_sort = 1676,                   /* -reverse-sort */
  OPT_s = 1677,                              /* -s */
  OPT_save_temps = 1678,                     /* -save-temps */
  OPT_save_temps_ = 1679,                    /* -save-temps= */
  OPT_shared = 1680,                         /* -shared */
  OPT_shared_libgcc = 1681,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1682,               /* -shared-libphobos */
  OPT_size_sort = 1683,                      /* -size-sort */
  /* OPT_specs = 1684, */                    /* -specs */
  OPT_specs_ = 1685,                         /* -specs= */
  OPT_static = 1686,                         /* -static */
  OPT_static_libasan = 1687,                 /* -static-libasan */
  OPT_static_libgcc = 1688,                  /* -static-libgcc */
  OPT_static_libgfortran = 1689,             /* -static-libgfortran */
  OPT_static_libgo = 1690,                   /* -static-libgo */
  OPT_static_liblsan = 1691,                 /* -static-liblsan */
  OPT_static_libmpx = 1692,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1693,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1694,               /* -static-libphobos */
  OPT_static_libstdc__ = 1695,               /* -static-libstdc++ */
  OPT_static_libtsan = 1696,                 /* -static-libtsan */
  OPT_static_libubsan = 1697,                /* -static-libubsan */
  OPT_static_pie = 1698,                     /* -static-pie */
  /* OPT_std_c__03 = 1699, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1700, */                /* -std=c++0x */
  OPT_std_c__11 = 1701,                      /* -std=c++11 */
  OPT_std_c__14 = 1702,                      /* -std=c++14 */
  OPT_std_c__17 = 1703,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1704, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1705, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1706, */                /* -std=c++20 */
  OPT_std_c__2a = 1707,                      /* -std=c++2a */
  OPT_std_c__98 = 1708,                      /* -std=c++98 */
  OPT_std_c11 = 1709,                        /* -std=c11 */
  OPT_std_c17 = 1710,                        /* -std=c17 */
  /* OPT_std_c18 = 1711, */                  /* -std=c18 */
  /* OPT_std_c1x = 1712, */                  /* -std=c1x */
  OPT_std_c2x = 1713,                        /* -std=c2x */
  /* OPT_std_c89 = 1714, */                  /* -std=c89 */
  OPT_std_c90 = 1715,                        /* -std=c90 */
  OPT_std_c99 = 1716,                        /* -std=c99 */
  /* OPT_std_c9x = 1717, */                  /* -std=c9x */
  OPT_std_f2003 = 1718,                      /* -std=f2003 */
  OPT_std_f2008 = 1719,                      /* -std=f2008 */
  OPT_std_f2008ts = 1720,                    /* -std=f2008ts */
  OPT_std_f2018 = 1721,                      /* -std=f2018 */
  OPT_std_f95 = 1722,                        /* -std=f95 */
  OPT_std_gnu = 1723,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1724, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1725, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1726,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1727,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1728,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1729, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1730, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1731, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1732,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1733,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1734,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1735,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1736, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1737, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1738,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1739, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1740,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1741,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1742, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1743, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1744,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1745, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1746, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1747, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1748, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1749, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1750,                     /* -std=legacy */
  OPT_symbol_ = 1751,                        /* -symbol= */
  OPT_symbolic = 1752,                       /* -symbolic */
  OPT_t = 1753,                              /* -t */
  OPT_time = 1754,                           /* -time */
  OPT_time_ = 1755,                          /* -time= */
  OPT_traditional = 1756,                    /* -traditional */
  OPT_traditional_cpp = 1757,                /* -traditional-cpp */
  OPT_tree_stats = 1758,                     /* -tree-stats */
  OPT_trigraphs = 1759,                      /* -trigraphs */
  OPT_type_stats = 1760,                     /* -type-stats */
  OPT_u = 1761,                              /* -u */
  OPT_undef = 1762,                          /* -undef */
  OPT_v = 1763,                              /* -v */
  OPT_version = 1764,                        /* -version */
  OPT_w = 1765,                              /* -w */
  OPT_wrapper = 1766,                        /* -wrapper */
  OPT_x = 1767,                              /* -x */
  OPT_z = 1768,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
